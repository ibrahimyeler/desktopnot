...
import Repurchase from '@/components/account/Repurchase';
import { Bars3Icon, XMarkIcon } from '@heroicons/react/24/outline';

const RepurchasePageClient = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex gap-4 lg:gap-6 xl:gap-8 2xl:gap-12">
          {/* Desktop Sidebar */}
          ...
          <div className="flex-1 max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
            <Repurchase onMenuClick={() => setSidebarOpen(true)} />
          </div>
        </div>
      </div>
        </div>
...
export default RepurchasePageClient;
