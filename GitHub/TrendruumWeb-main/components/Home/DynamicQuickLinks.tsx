...
export default function DynamicQuickLinks({ links }: DynamicQuickLinksProps) {
  ...
  return (
    <div className="bg-white py-1 mb-5">
      <div className="container mx-auto px-2 sm:px-4">
        <div className="flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center sm:gap-3 max-w-7xl mx-auto" style={{ flexDirection: 'column' }}>
          <style jsx>{`
          ...
          {links.map((link, index) => (
            ...
            >
              <span className="text-sm font-extrabold sm:text-base lg:text-lg">
                {link.title}
              </span>
            </button>
          ))}
