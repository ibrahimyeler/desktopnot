...
const ProductListSection: React.FC<ProductListSectionProps> = ({
  ...
  return (
    <div className="store-product-list-section w-full max-w-full sm:max-w-[92%] md:max-w-[90%] lg:max-w-[88%] xl:max-w-[1600px] mx-auto px-2 sm:px-3 md:px-4 lg:px-5 xl:px-6 2xl:px-8 bg-white p-0">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">{title}</h2>
        {/* <a href={seeAllUrl} className="text-orange-600 font-semibold text-sm sm:text-base md:text-lg hover:underline whitespace-nowrap">Tümünü Gör</a> */}
      </div>
      {products.length === 0 ? (
