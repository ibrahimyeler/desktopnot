...
const ComplementaryProducts: React.FC<ComplementaryProductsProps> = ({
  ...
  const fetchCategoryProducts = async (categoryId: string) => {
    ...
    try {
      ...
      if (data.meta && data.meta.status === 'success' && data.data) {
        ...
        setComplementaryProducts(randomProducts);
      } else {
  ...
  useEffect(() => {
    ...
    if (currentCategoryId && !propProducts?.length) {
      ...
      setComplementaryProducts(propProducts);
    }
  ...
  const renderProductCard = (product: Product) => {
    ...
    return (
      <div className={`bg-white rounded-lg overflow-hidden flex flex-col relative group hover:shadow-lg transition-all duration-200 border border-gray-300 ${isOutOfStock ? 'opacity-75' : ''}`}>
        {/* Favori İkonu */}
        <button 
      ...
      <div className="mt-8 w-full bg-white pt-2 pb-2">
        <div className="max-w-7xl mx-auto px-2 sm:px-3 lg:px-4 xl:px-6 2xl:px-8">
          <div className="relative rounded-xl p-3 bg-white">
            ...
            Bu Ürünü Alanlar Bunları da Aldı            </h2>
  ...
  return (
    <div className="mt-8 w-full bg-white pt-2 pb-2">
      <div className="max-w-7xl mx-auto px-2 sm:px-3 lg:px-4 xl:px-6 2xl:px-8">
        <div className="relative rounded-xl p-3 bg-white">
          ...
          <div className="px-2 sm:px-4 md:px-6 pb-2">
            <div className="relative complementary-products-wrapper">
              <Swiper
                ref={swiperRef}
                className="complementary-products-swiper"
                modules={[]}
                spaceBetween={4}
                slidesPerView={2}
      ...
      <style jsx global>{`
        ...
        .complementary-products-swiper .swiper-wrapper {
          display: flex;
          width: auto;
          transform: translate3d(0px, 0, 0);
        }
        .complementary-products-swiper .swiper-slide {
          height: auto;
          flex-shrink: 0;
          width: auto;
        }
