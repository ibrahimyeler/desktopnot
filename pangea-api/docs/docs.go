...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/admin/admins/{id}/roles": {
            "put": {
                ...
                "description": "Update admin's role and permissions",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Update admin roles (Admin)",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Admin ID",
                    ...
                    {
                        "description": "Admin role and permission update data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/admin/content": {
            "get": {
                ...
                "description": "Get list of all content with pagination",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/v1/admin/content/{id}": {
            "get": {
                ...
                "description": "Get specific content details by ID",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/v1/admin/content/{id}/unpublish": {
            "post": {
                ...
                "summary": "Unpublish content (Admin)",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Content ID",
        ...
        "/api/v1/admin/security/sessions/{id}/terminate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "summary": "Terminate session (Admin)",
                "parameters": [
                    {
                        "type": "string",
    ...
    "definitions": {
        ...
        "handlers.AdminLoginResponse": {
            ...
            "properties": {
                "admin": {
                    "$ref": "#/definitions/handlers.Admin"
                },
                "message": {
                    "type": "string"
                },
